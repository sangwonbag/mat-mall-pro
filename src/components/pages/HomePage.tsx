          ...
          >
            <div className="relative">
              <Input
                ...
                className="w-full h-16 pl-6 pr-20 text-lg rounded-full border-2 border-gray-300 bg-white focus:border-primary focus:bg-white shadow-lg"
              />
              <Button
              ...
              <Button
                ...
                className="absolute right-16 top-2 h-12 w-12 rounded-full bg-transparent hover:bg-gray-100 text-foreground"
              >
          ...
          >
            {categories.map((category) => (
              <Button
                ...
                className="px-8 py-3 rounded-full bg-white text-primary border-2 border-gray-300 hover:bg-primary hover:border-primary hover:text-white transition-all duration-300"
              >
